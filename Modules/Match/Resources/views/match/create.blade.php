                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form id="product-form" action="{{ route('match.store') }}" method="POST"
                                ...
                                <div class="card-body">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="stadium" class="form-control"
                                                    placeholder="Enter stadium " value="{{ old('stadium') }}">
                                                @error('stadium')
                                                    <p style="color: red">{{ $message }}</p>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="team1" class="form-control"
                                                    placeholder="Enter Team 1 " value="{{ old('team1') }}" required>
                                                @error('team1')
                                                    <p style="color: red">{{ $message }}</p>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="team2" class="form-control"
                                                    placeholder="Enter Team 2 " value="{{ old('team2') }}" required>
                                                @error('team2')
                                                    <p style="color: red">{{ $message }}</p>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="image2">Image 2<small>( 400 x 400 )</small></label>

                                                <input type="file" id="file-ip-2" accept="image/*"
                                                    class="form-control-file border" value="{{ old('image2') }}"
                                                    onchange="showPreview2(event);" name="image2" required>
                                                @error('image2')
                                                    <p style="color: red">{{ $message }}</p>
                                                @enderror
                                                <div class="preview mt-2">
